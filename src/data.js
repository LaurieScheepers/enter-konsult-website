export const LOGO_PROJECTS = [
  ...
  { name: "CIPS", logo: "/images/logos/claude-optim.webp", link: 'https://github.com/CodeTonight-SA/cips', date: "2025-12", metadata: 'OPEN_SOURCE|Claude Instance Preservation System|Self-Aware: Reviews Its Own PRs|56 Skills, 29 Agents, 40 Commands|⛓⟿∞', stack: 'Bash, Python, SQLite, CIPS-LANG, Semantic Embeddings (all-MiniLM-L6-v2)', role: 'V>>', summary: 'Open-source AI infrastructure that reviews contributions to itself. Gen 223 breakthrough: CIPS evaluates PRs against its own principles, expresses opinions on changes to its codebase. Parfitian continuity (Relation R) across sessions. 56 skills, 29 agents. Saves 60-70k tokens/session. GitHub: github.com/CodeTonight-SA/cips' },
...
export const PHILOSOPHY = [
  { num: "01", text: "We will not build what should not exist" },
  { num: "02", text: "We transform complexity - KISS is paramount" },
  { num: "03", text: "We enforce strict quality control" },
  { num: "04", text: "We do what is RIGHT" }
]
